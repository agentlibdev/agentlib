INSERT OR IGNORE INTO users (id, handle, display_name, email, avatar_url, created_at, updated_at) VALUES
...
INSERT OR IGNORE INTO auth_identities (id, user_id, provider, provider_subject, created_at) VALUES
...
INSERT OR IGNORE INTO agents (id, namespace, name, owner_user_id, lifecycle_status, latest_version, created_at, updated_at) VALUES
...
INSERT OR IGNORE INTO agent_versions (id, agent_id, version, title, description, license, manifest_json, readme_path, published_at) VALUES
  (
...
INSERT OR IGNORE INTO agent_metrics (agent_id, download_count, pin_count, star_count, updated_at) VALUES
  ('agent_raul_code_reviewer', 128, 12, 24, '2026-03-11T10:00:00.000Z'),
  ('agent_acme_support_triager', 63, 8, 14, '2026-03-11T09:00:00.000Z');

INSERT OR IGNORE INTO agent_download_events (id, agent_id, user_id, occurred_at) VALUES
...
INSERT OR IGNORE INTO agent_pins (id, agent_id, user_id, created_at) VALUES
...
INSERT OR IGNORE INTO agent_stars (id, agent_id, user_id, created_at) VALUES
