import type { AgentCompatibility } from "../packages/core/src/agent-record.js";

export const superpowersCompatibility: AgentCompatibility = {
  targets: [
    {
      targetId: "codex",
      builtFor: true,
...
export function resolveSuperpowersVersion(explicitVersion?: string) {
